...
function blossom_coach_header(){     
    ...
    <header id="masthead" class="site-header" itemscope itemtype="http://schema.org/WPHeader">		
        ...
        <div class="header-t">
			<div class="wrapper">
			<?php
                blossom_coach_header_phone_email( $phone, $email );
        ...
        <div class="main-header">
			<div class="wrapper">
				...
				<div class="menu-wrap">				
                    <?php 
                    blossom_coach_primary_nagivation();
...
function blossom_coach_author(){ 
    ...
    <div class="author-profile">
		...
		<div class="author-content-wrap">
			<?php 
                printf( esc_html__( '%1$sAbout %2$s%3$s%4$s', 'blossom-coach' ), '<h3 class="author-name">', '<span class="vcard">', esc_html( get_the_author_meta( 'display_name' ) ), '</span></h3>' );                
...
if( ! function_exists( 'blossom_coach_instagram' ) ) :
/**
 * Blossom Instagram
*/
function blossom_coach_instagram(){
...
add_action( 'blossom_coach_before_footer', 'blossom_coach_instagram', 22 );
