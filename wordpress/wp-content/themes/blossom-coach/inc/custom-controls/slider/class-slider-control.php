<?php
/**
 * Blossom Coach Customizer Slider Control.
 * 
...
if ( ! class_exists( 'Blossom_Coach_Slider_Control' ) ){
	/**
	 * Slider control (range).
    */
	class Blossom_Coach_Slider_Control extends WP_Customize_Control {

		public $type = 'blossom-coach-slider';
        ...
        public function enqueue() {            
            wp_enqueue_style( 'blossom-coach-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'blossom-coach-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
