...
/**
 * Class Blossom_Coach_Getting_Started_Page_Plugin_Helper
 *
 * @package Blossom_Coach_Getting_Start_Page
 */
class Blossom_Coach_Getting_Started_Page_Plugin_Helper {
	/**
	 * Instance of class.
	 ...
	 *
	 * @return Blossom_Coach_Getting_Started_Page_Plugin_Helper;
	 */
	public static function instance() {
		if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Blossom_Coach_Getting_Started_Page_Plugin_Helper ) ) {
			self::$instance = new Blossom_Coach_Getting_Started_Page_Plugin_Helper();
		}
	...
	public function get_button_html( $slug, $settings = array() ) {
		...
		switch ( $state ) {
			...
			case 'enable_cpt':
				...
				$button .= '<a  data-redirect="' . esc_url( $redirect ) . '" class="button" href="' . esc_url( $url ) . '">' . esc_html__( 'Activate', 'blossom-coach' ) . ' ' . esc_html__( 'Jetpack Portfolio', 'blossom-coach' ) . '</a>';
				break;
		}// End switch().
		$button .= '</div>';
