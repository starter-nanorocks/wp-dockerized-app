...
<div id="help-panel" class="panel-left">
    ...
    <div class="panel-aside">
        ...
        <a class="button button-primary" href="<?php echo esc_url( 'https://docs.blossomthemes.com/' . BLOSSOM_COACH_THEME_TEXTDOMAIN . '/' ); ?>" title="<?php esc_attr_e( 'Visit the Documentation', 'blossom-coach' ); ?>" target="_blank"><?php esc_html_e( 'View Documentation', 'blossom-coach' ); ?></a>
    </div><!-- .panel-aside -->
    
    <div class="panel-aside">
        <h4><?php esc_html_e( 'Support Ticket', 'blossom-coach' ); ?></h4>
        <p><?php printf( __( 'It\'s always a good idea to visit our %1$sKnowledge Base%2$s before you send us a support ticket.', 'blossom-coach' ), '<a href="'. esc_url( 'https://docs.blossomthemes.com/' . BLOSSOM_COACH_THEME_TEXTDOMAIN . '/' ) .'" target="_blank">', '</a>' ); ?></p>
    ...
    <div class="panel-aside">
        ...
        <a class="button button-primary" href="<?php echo esc_url( 'https://blossomthemes.com/theme-demo/?theme=' . BLOSSOM_COACH_THEME_TEXTDOMAIN ); ?>" title="<?php esc_attr_e( 'Visit the Demo', 'blossom-coach' ); ?>" target="_blank"><?php esc_html_e( 'View Demo', 'blossom-coach' ); ?></a>
    </div><!-- .panel-aside -->
</div>
