...
function blossom_coach_customize_register_general( $wp_customize ) {
    ...
    $wp_customize->add_setting(
        ...
        array(
            'default'           => '',
            'sanitize_callback' => 'blossom_coach_sanitize_phone_number', 
    ...
    $wp_customize->add_section(
        'instagram_settings',
        array(
            'title'    => __( 'Instagram Settings', 'blossom-coach' ),
            'priority' => 60,
            'panel'    => 'general_settings',
        )
    );
    
    if( blossom_coach_is_btif_activated() ){
        ...
        $wp_customize->add_control(
            new Blossom_Coach_Toggle_Control( 
                ...
                array(
                    ...
                    'label'       => __( 'Instagram Section', 'blossom-coach' ),
                    'description' => __( 'Enable to show Instagram Section', 'blossom-coach' ),
                )
            )
        );
        ...
        $wp_customize->add_control(
            new Blossom_Coach_Note_Control( 
                ...
                array(
                    'section'     => 'instagram_settings',
                    'description' => sprintf( __( 'You can change the setting of BlossomThemes Social Feed %1$sfrom here%2$s.', 'blossom-coach' ), '<a href="' . esc_url( admin_url( 'admin.php?page=class-blossomthemes-instagram-feed-admin.php' ) ) . '" target="_blank">', '</a>' )
                )
            )
        );        
    }else{
        ...
        $wp_customize->add_control(
            new Blossom_Coach_Note_Control( 
                ...
                array(
                    'section'     => 'instagram_settings',
                    'description' => sprintf( __( 'Please install and activate the recommended plugin %1$sBlossomThemes Social Feed%2$s. After that option related with this section will be visible.', 'blossom-coach' ), '<a href="' . esc_url( admin_url( 'themes.php?page=tgmpa-install-plugins' ) ) . '" target="_blank">', '</a>' )
                )
            )
        );
    }
