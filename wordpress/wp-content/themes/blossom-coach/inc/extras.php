...
if( ! function_exists( 'blossom_coach_site_branding' ) ) :
/**
 * Site Branding
*/
function blossom_coach_site_branding(){ 
...
if( ! function_exists( 'blossom_coach_primary_nagivation' ) ) :
/**
 * Function for mobile navigation menu
 */
function blossom_coach_primary_nagivation(){ 
    ?>
    <nav id="site-navigation" class="main-navigation" itemscope itemtype="http://schema.org/SiteNavigationElement">
        <button type="button" class="toggle-button" data-toggle-target=".main-menu-modal" data-toggle-body-class="showing-main-menu-modal" aria-expanded="false" data-set-focus=".close-main-nav-toggle" aria-label="<?php esc_attr_e('Mobile Navigation', 'blossom-coach'); ?>">
            <span class="toggle-bar"></span>
            <span class="toggle-bar"></span>
            <span class="toggle-bar"></span>
        </button>
        <div class="primary-menu-list main-menu-modal cover-modal" data-modal-target-string=".main-menu-modal">
            <button class="close close-main-nav-toggle" data-toggle-target=".main-menu-modal" data-toggle-body-class="showing-main-menu-modal" aria-expanded="false" data-set-focus=".main-menu-modal" aria-label="<?php esc_attr_e('Mobile Navigation', 'blossom-coach'); ?>"><span></span></button>
...
if( ! function_exists( 'blossom_coach_header_search' ) ) :
/**
 * Header Search 
*/
function blossom_coach_header_search( $echo = true ){
    ?>
    <div class="header-search">
        <button aria-label="<?php esc_attr_e('search form toggle', 'blossom-coach'); ?>" data-toggle-target=".search-modal" data-toggle-body-class="showing-search-modal" data-set-focus=".search-modal .search-field" aria-expanded="false">
            <i class="fa fa-search"></i>
        </button>
        <div class="header-search-form search-modal cover-modal" data-modal-target-string=".search-modal">
            <div class="header-search-inner-wrap">
                <?php get_search_form(); ?>
                <button aria-label="<?php esc_attr_e('search form close', 'blossom-coach'); ?>" class="close" data-toggle-target=".search-modal" data-toggle-body-class="showing-search-modal" data-set-focus=".search-modal .search-field" aria-expanded="false"></button>
            </div>
        </div>
    </div>
    <?php
...
if( ! function_exists( 'blossom_coach_header_phone_email' ) ) :
/**
 * Header Search 
*/
function blossom_coach_header_phone_email( $phone, $email ){
...
*/
function blossom_coach_is_btif_activated(){
 ...
 */
function blossom_coach_is_wheel_of_life_activated() {
...
*/
function blossom_coach_is_elementor_activated(){
    return class_exists( 'Elementor\\Plugin' ) ? true : false; 
}

if( ! function_exists( 'blossom_coach_get_image_sizes' ) ) :
/**
 * Get information about available image sizes
 */
function blossom_coach_get_image_sizes( $size = '' ) {
...
if ( ! function_exists( 'blossom_coach_get_fallback_svg' ) ) :    
/**
 * Get Fallback SVG
*/
function blossom_coach_get_fallback_svg( $post_thumbnail ) {
    if( ! $post_thumbnail ){
        return;
    }
    
    $image_size = blossom_coach_get_image_sizes( $post_thumbnail );
...
if( ! function_exists( 'blossom_coach_breadcrumb' ) ) :
/**
 * Breadcrumbs
*/
function blossom_coach_breadcrumb(){ 
    global $post;
    $post_page  = get_option( 'page_for_posts' ); //The ID of the page that displays posts.
    $show_front = get_option( 'show_on_front' ); //What to show on the front page    
    $home       = get_theme_mod( 'home_text', __( 'Home', 'blossom-coach' ) ); // text for the 'Home' link
    ...
    if( get_theme_mod( 'ed_breadcrumb', true ) ){
        ...
        $depth = 1;
        echo '<div class="breadcrumb-wrapper"><div class="wrapper">
        ...
        if( is_home() ){
        ...
        }elseif( blossom_coach_is_woocommerce_activated() && ( is_product_category() || is_product_tag() ) ){ //For Woocommerce archive page
        ...
        }elseif( blossom_coach_is_woocommerce_activated() && is_shop() ){ //Shop Archive page
            ...
            echo $before .'<a itemprop="item" href="'. esc_url( $request_uri ) .'"><span itemprop="name">'. esc_html__( 'Search Results for "', 'blossom-coach' ) . esc_html( get_search_query() ) . esc_html__( '"', 'blossom-coach' ) .'</span></a><meta itemprop="position" content="'. absint( $depth ).'" />'. $after;
        
        }elseif( is_day() ){
            
            $depth = 2;
            echo '<span itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="' . esc_url( get_year_link( get_the_time( __( 'Y', 'blossom-coach' ) ) ) ) . '"><span itemprop="name">' . esc_html( get_the_time( __( 'Y', 'blossom-coach' ) ) ) . ' </span></a><meta itemprop="position" content="'. absint( $depth ).'"/><span class="separator">' . $delimiter . '</span></span> ';
            $depth ++;
            echo '<span itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="' . esc_url( get_month_link( get_the_time( __( 'Y', 'blossom-coach' ) ), get_the_time( __( 'm', 'blossom-coach' ) ) ) ) . '"><span itemprop="name">' . esc_html( get_the_time( __( 'F', 'blossom-coach' ) ) ) . ' </span></a><meta itemprop="position" content="'. absint( $depth ).'" /><span class="separator">' . $delimiter . '</span></span> ';
            $depth ++;
            echo $before .'<a itemprop="item" href="' . esc_url( get_day_link( get_the_time( __( 'Y', 'blossom-coach' ) ), get_the_time( __( 'm', 'blossom-coach' ) ), get_the_time( __( 'd', 'blossom-coach' ) ) ) ) . '"><span itemprop="name">'. esc_html( get_the_time( __( 'd', 'blossom-coach' ) ) ) .'</span></a><meta itemprop="position" content="'. absint( $depth ).'" />'. $after;
            ...
            echo '<span itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a itemprop="item" href="' . esc_url( get_year_link( get_the_time( __( 'Y', 'blossom-coach' ) ) ) ) . '"><span itemprop="name">' . esc_html( get_the_time( __( 'Y', 'blossom-coach' ) ) ) . ' </span></a><meta itemprop="position" content="'. absint( $depth ).'" /><span class="separator">' . $delimiter . '</span></span> ';
            $depth++;
            echo $before .'<a itemprop="item" href="' . esc_url( get_month_link( get_the_time( __( 'Y', 'blossom-coach' ) ), get_the_time( __( 'm', 'blossom-coach' ) ) ) ) . '"><span itemprop="name">'. esc_html( get_the_time( __( 'F', 'blossom-coach' ) ) ) .'</span></a><meta itemprop="position" content="'. absint( $depth ).'" />'. $after;
        
        }elseif( is_year() ){
            
            $depth = 2;
            echo $before .'<a itemprop="item" href="' . esc_url( get_year_link( get_the_time( __( 'Y', 'blossom-coach' ) ) ) ) . '"><span itemprop="name">'. esc_html( get_the_time( __( 'Y', 'blossom-coach' ) ) ) .'</span></a><meta itemprop="position" content="'. absint( $depth ).'" />'. $after;
    
        }elseif( is_single() && !is_attachment() ){
            
            if( blossom_coach_is_woocommerce_activated() && 'product' === get_post_type() ){ //For Woocommerce single product
                ...
                if( get_post_type() =='blossom-portfolio' ){
                    // Add support for a non-standard label of 'archive_title' (special use case).
                   $label = !empty( $post_type->labels->archive_title ) ? $post_type->labels->archive_title : $post_type->labels->name;
                   $portfolio_link = blossom_coach_get_page_template_url( 'templates/blossom-portfolio.php' );
            ...
            if( get_query_var('paged') ){
                ...
                echo ' <span class="separator">' . $delimiter . '</span></span> ' . $before . sprintf( __('Page %s', 'blossom-coach'), get_query_var('paged') ) . $after;
            }elseif( is_archive() ){
           ...
           $depth = 2;
            ...
            echo $before . esc_html__( '404 Error - Page Not Found', 'blossom-coach' ) . $after;
        }
        
        if( get_query_var('paged') ) echo __( ' (Page', 'blossom-coach' ) . ' ' . get_query_var('paged') . __( ')', 'blossom-coach' );
...
if( ! function_exists( 'blossom_coach_get_page_template_url' ) ) :
/**
 * Returns page template url if not found returns home page url
*/
function blossom_coach_get_page_template_url( $page_template ){
    $args = array(
